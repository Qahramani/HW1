        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    if (brandName == "Nike" || brandName == "Adidas" || brandName == "Puma")
                        break;
                    else
                        Console.WriteLine("Duzgun Brand adi elave eleyin");
                ...
                while (true)
                {
                    ...
                    if (category == "Sport" || category == "Boat" || category == "Heels" || category == "Ballet ")
                        break;
                    else
                        Console.WriteLine("Duzgun categoriyani daxil ediniz ");
                }
                #endregion
                ...
                while (true)
                {
                    ...
                    if (price > 0)
                        ...
                        Console.WriteLine("Duzgun qiymeti daxil ediniz");
                ...
                while (true)
                {
                    ...
                    if (count >= 0 && count <= 100)
                        ...
                        Console.WriteLine("Duzgun sayi daxil ediniz");
                }
                #endregion
